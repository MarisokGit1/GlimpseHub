            ...
            categories = new List<Category>()
                    {
                        ...
                        new Category()
                        {
                         Name = "Motorcycles",
                         CreatedOn = DateTime.Now.AddMonths(-2).Date,
                         Description = "Post cool photos of some bikes",
                         IsDeleted = false,
                         PictureUrl="https://content2.kawasaki.com/ContentStorage/KMC/Products/9026/eed00231-bf59-4521-8da9-5597fb475736.png?w=767"
                        },
                        new Category()
                        {
                         Name = "Sports",
                         CreatedOn = DateTime.Now.AddMonths(-2).Date,
                         Description = "Post stuff about sports",
                         IsDeleted = false,
                         PictureUrl="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTKq0EeZGH2DCjRYLxbwytpcjdLejbVPLfDQQ&s"
                        },
            ...
            galleries = new List<Gallery>()
                        {
                            new Gallery()
                            {
                             ...
                             Category=categories[0],
                                Author=users[0],
                             MainPicture = "https://www.gbzoo.com/resources/media/user/1689619253-Featured-Orangutan-01_1920x1050_desktop.jpg"
                            ...
                            new Gallery()
                            {
                             ...
                             Author=users[0],
                             MainPicture = "https://bambiniphoto.sg/wp-content/uploads/family-photography-bambini-025.jpg"
                            ...
                            new Gallery()
                            {
                             ...
                             Author=users[0],
                             MainPicture = "https://media.istockphoto.com/id/1457979959/photo/snack-junk-fast-food-on-table-in-restaurant-soup-sauce-ornament-grill-hamburger-french-fries.webp?b=1&s=170667a&w=0&k=20&c=A_MdmsSdkTspk9Mum_bDVB2ko0RKoyjB7ZXQUnSOHl0="
                            ...
                            new Gallery()
                            {
                             ...
                             Author=users[0],
                             MainPicture = "https://images.rawpixel.com/image_800/czNmcy1wcml2YXRlL3Jhd3BpeGVsX2ltYWdlcy93ZWJzaXRlX2NvbnRlbnQvcGR2YW5nb2doLXNlbGYtcG9ydHJhaXQtbTAxLWpvYjY2MV8yLWwxMDBvNmVmLmpwZw.jpg"
